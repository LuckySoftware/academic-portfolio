...
const portfolioData = {
  ...
  skills: [
    { name: 'Java', percentage: 90, color: 'bg-red-500' },
    { name: 'Python', percentage: 82, color: 'bg-green-400' },
    { name: 'PHP', percentage: 70, color: 'bg-blue-500' },
    { name: 'CSS', percentage: 95, color: 'bg-blue-600' },
    { name: 'HTML', percentage: 97, color: 'bg-orange-600' },
    { name: 'JavaScript', percentage: 75, color: 'bg-yellow-400' },
    { name: 'Git', percentage: 93, color: 'bg-orange-500' },
    { name: 'SQL', percentage: 85, color: 'bg-yellow-600' },
    { name: 'Linux Server', percentage: 70, color: 'bg-purple-600' },
    { name: 'Data Analitics', percentage: 83, color: 'bg-teal-600' },
  ],
  projects: [
    {
